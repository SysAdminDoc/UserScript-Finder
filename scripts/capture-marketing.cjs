...
async function renderSocialCard(browser) {
  ...
  </style></head><body><div class="frame"><section class="copy"><div class="brand"><img src="data:image/png;base64,${logo}"><div><div class="name">UserScript Finder</div><div class="version">v1.29.2</div></div></div><h1>Find the right script without leaving the site.</h1><p>Search eight sources, compare signals, and inspect match coverage or source code before you install.</p><div class="proof"><span>8 sources</span><span>Match checks</span><span>Source preview</span><span>Local settings</span></div></section><section class="product"><img src="data:image/png;base64,${product}"></section><div class="accent"></div></div></body></html>`);
