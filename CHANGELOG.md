...
- Preserved both original magnifier-and-script logo directions in the repository.
- Added a selection record and untouched master for the approved compact mark.
- Recaptured all product and repository artwork from the production userscript for this release.
- Restored the missing version headings in the historical changelog.
