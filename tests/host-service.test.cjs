...
assert.deepEqual(Array.from(HostService.relatedSearchHosts("youtu.be")), ["youtu.be", "youtube.com"]);
assert.deepEqual(Array.from(HostService.relatedSearchHosts("music.youtube.com")), ["music.youtube.com", "youtube.com"]);
assert.deepEqual(Array.from(HostService.relatedSearchHosts("example.com")), ["example.com"]);
